package com.bingoxwallet.scripttool;

import com.bingoxwallet.scripttool.Entity.CachedResult;
import com.bingoxwallet.scripttool.Entity.ParseState;
import com.bingoxwallet.scripttool.Entity.TokenscriptFunction;
import com.bingoxwallet.scripttool.Ethereum.TransactionHandler;
...
import static com.bingoxwallet.scripttool.Entity.ParseState.ARG;
import static com.bingoxwallet.scripttool.Entity.ParseState.TS_FILE;
import static com.bingoxwallet.scripttool.Entity.ParseState.USER_ADDR;
        ...
        for (String arg : args)
        {
            switch (p)
            {
                ...
                case USER_ADDR:
                    ...
                    {
                        System.out.println("ERROR: " + arg + " is not a valid Bingoreum address");
                    }
                    p = ARG;
                    break;
                case TS_FILE:
