...
import com.bingoxwallet.token.util.DateTime;
import com.bingoxwallet.token.util.DateTimeFactory;
        ...
        switch (getAs())
        {
            ...
            case Mapping:
                ...
                else
                {
                    ...
                    //refer to 'BingoXWallet meetup indices' where 'Match' mapping is null but for FIFA is not.
