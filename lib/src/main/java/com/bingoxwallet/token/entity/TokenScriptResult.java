...
import static com.bingoxwallet.token.tools.TokenDefinition.Syntax.IA5String;
...
public class TokenScriptResult
{
    public static final class Attribute {
        ...
        public Attribute(com.bingoxwallet.token.entity.Attribute attr, BigInteger value, String text)
        {
            this.id = attr.name;
