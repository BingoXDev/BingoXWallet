package com.bingoxwallet.ethereum;
...
{ // implements EthereumNetworkRepositoryType
    public static final long BINGOXSC_ID = 14444;//by TB
    ...
    public static final String BINGOXSC_RPC_URL = "https://bvm.bingox.cc";//by TB
    ...
    {
        {
            put(BINGOXSC_ID, new NetworkInfo("BingoXSmartChain", "BGC", BINGOXSC_RPC_URL, "http://explorer.bingox.cc/tx/",
                    BINGOXSC_ID, false));//by TB
