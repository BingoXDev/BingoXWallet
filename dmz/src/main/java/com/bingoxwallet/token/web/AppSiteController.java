package com.bingoxwallet.token.web;

import static com.bingoxwallet.token.tools.Convert.getEthString;
import static com.bingoxwallet.token.tools.ParseMagicLink.normal;
import static com.bingoxwallet.token.web.Ethereum.TokenscriptFunction.ZERO_ADDRESS;

import com.bingoxwallet.token.entity.Attribute;
import com.bingoxwallet.token.entity.AttributeInterface;
import com.bingoxwallet.token.entity.ContractAddress;
import com.bingoxwallet.token.entity.ContractInfo;
import com.bingoxwallet.token.entity.MagicLinkData;
import com.bingoxwallet.token.entity.MagicLinkInfo;
import com.bingoxwallet.token.entity.NonFungibleToken;
import com.bingoxwallet.token.entity.SalesOrderMalformed;
import com.bingoxwallet.token.entity.TokenScriptResult;
import com.bingoxwallet.token.entity.TransactionResult;
import com.bingoxwallet.token.tools.ParseMagicLink;
import com.bingoxwallet.token.tools.TokenDefinition;
import com.bingoxwallet.token.web.Ethereum.TokenscriptFunction;
import com.bingoxwallet.token.web.Ethereum.TransactionHandler;
import com.bingoxwallet.token.web.Service.CryptoFunctions;
...
public class AppSiteController implements AttributeInterface
{
    ...
    private static final String appleAssociationConfig = "{\n" +
            ...
            "    \"details\": [\n" +
            "      {\n" +
            "        \"appID\": \"LRAW5PL536.com.bingobird.bingoxwallet\",\n" +
            "        \"paths\": [ \"*\" ]\n" +
            "      }\n" +
            "    ]\n" +
            "  }\n" +
    ...
    private static final String androidAssociationConfig = "[\n" +
            ...
            "      \"package_name\": \"io.bingobird.wallet\",\n" +
    ...
    public RedirectView home(RedirectAttributes attributes){
        return new RedirectView("http://wallet.bingox.cc");
    }
            ...
            throws IOException, SAXException, NoHandlerFoundException
    {
        ...
        {
            return "If you are using BingoXWallet with WalletConnect and facing issues please take the following steps:<br/><br/>\nTry using WalletConnect V2 (or latest version)<br/>\nTry launching the application from within BingoXWallet app's Browser tab.<br/>";
        }
